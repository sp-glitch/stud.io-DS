...
foreach ($s in @('home.html','home-light.html','elearning.html','elearning-light.html','original.html','original-light.html','video.html','video-light.html','askhr.html','askhr-light.html')) { $html = $html.Replace('href="samples/' + $s + '"', 'href="../samples/' + $s + '"') }
